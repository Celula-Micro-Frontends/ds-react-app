...
import "./App.css";
import { InputComponent, MyComponent, LoaderComponent } from "react-library";
    ...
    <div className="grid-container">
      ...
      <div>
        ...
        <div className="custom-loader-container">
          <LoaderComponent type="bubbles" svg-size="180" text="NTTDATA" ></LoaderComponent>
          <LoaderComponent color="#28a745" text="¡Cargado!"> </LoaderComponent>
          <LoaderComponent type="bars" text="loader" ></LoaderComponent>
          <LoaderComponent
            type="svg"
